...
const CommandMenu = () => {
  ...
  return (
    <Command.Dialog
      ...
      className="absolute z-[100] h-screen w-full bg-black/20"
    >
      <div className="absolute left-1/2 top-1/2 z-[100] w-full max-w-2xl -translate-x-1/2 -translate-y-1/2 p-2">
        <img
          src="/frame.svg"
