          ...
          <div className="w-full">
            <div className="container flex h-28 items-center justify-between">
              ...
              <a
                ...
                target="_blank"
              >
                <button className="group inline-block cursor-pointer rounded-sm bg-sky-400 from-white to-white p-px hover:bg-gradient-to-r">
            ...
            <div className="col-span-2">
              ...
              <div className="flex items-center space-x-4">
                <a
                  ...
                  target="_blank"
                >
                  <button className="group relative inline-block cursor-pointer rounded-sm bg-sky-400 p-px hover:bg-white">
                    <div className="group absolute inline-block h-full w-full cursor-pointer rounded-sm bg-sky-400 p-px opacity-50 blur-lg" />
